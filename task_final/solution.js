...
function sendRequest(name, phone, address, goods, sum) {
    ...
    let addressLine=`ул. ${address.street}, дом ${address.house}, ${address.entrance} подъезд, ${address.floor} этаж, кв ${address.flat}`;
    let data = {data: {client, order: {address: addressLine, sum}, goods: []}};
